...
const Login = () => {
    return (
        <div className="flex flex-col justify-center items-center min-h-screen">
            <h1 className="font-bold sm:text-4xl text-2xl mt-9 items-center justify-center text-white neon-glow">Log in to your account</h1>
            <motion.div
            ...
            >
                ...
                >
                    ...
                    <Link to="/" className="text-orange-300 ml-1 underline">Sign Up</Link>
                </motion.h3>
            </motion.div>
        </div>
    );
